...
if ($Root -ne $PSScriptRoot) {
  ...
  foreach ($f in 'setup.ps1', 'canvas-watch.ps1', 'scaffold-class.ps1', 'standup.ps1', 'doctor.ps1', 'platform.ps1', 'notify.ps1') { Copy-Item (Join-Path $PSScriptRoot $f) $Root -Force }
